...
* Processor – x86, x86_64.   <br />
* 32 kB main memory (RAM).   <br />
* 384 kB secondary memory. (Hard Disk)  <br />
* Monitor for display.   <br />
* Keyboard for input.   <br />
## Software Requirements
* Basic operating system such as windows, Linux , UNIX, DOS, and many others.   <br />
